...
function downloadApp()
{
    if ( installApp() )
    {
        location.href = "welcomeocainstaller.exe";
    }
...
function helpWithApp()
{
    ...
    // document.location.href = "http://factory.snapback-apps.com/wordpress/wp-content/plugins/autologin-guest/autologin.php?redirect_to=http://factory.snapback-apps.com/wordpress/welcomeoca/wp-admin/post.php%3Fpost=12%26action=edit";
}
